...
from .model_utils import DecisionTransformerOutput, DTEvalWrapper
...
class VanillaDT(DecisionTransformerModel):
    ...
    def get_actions(self, states, actions, rewards, returns_to_go, timesteps, device, batch_size=1):
        ...
        actions = torch.ones_like(actions, device=states.device) * torch.tensor(0.5, device=states.device)
