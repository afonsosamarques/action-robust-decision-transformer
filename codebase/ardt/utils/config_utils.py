...
from ..models.ardt_vanilla import VanillaARDT
from ..models.ardt_multipart import MultipartARDT
...
def check_pipelinerun_config(config, do_checks=True):
    ...
    if do_checks:
        ...
        assert all([opn in ['d4rl', 'rarl', 'arrl', 'arrl_sgld', 'combo', 'robust', 'randagent', 'ppo'] for opn in pipeline_config.dataset_config.online_policy_names]), "Online policy name needs to be either 'd4rl', 'rarl', 'arrl', 'arrl_sgld', 'combo', 'robust', 'randagent' or 'ppo'."
        ...
        assert pipeline_config.model_config.agent_type in ['dt', 'ardt-vanilla', 'ardt_vanilla', 'ardt-multipart', 'ardt_multipart'], "Agent type needs to be either 'dt', 'ardt-vanilla', 'ardt_vanilla', 'ardt-multipart' or 'ardt_multipart'."
