...
def check_pipelinerun_config(config):
    ...
    assert pipeline_config.admin_config.wandb_project in ['afonsosamarques', 'ARDT-Project', 'ARDT-Internal', 'Experiment-1', 'Experiment-2'], "Wandb project needs to be either 'afonsosamarques' or 'ARDT-Project' or 'ARDT-Internal' or 'Experiment-1' or 'Experiment-2'."
    assert pipeline_config.admin_config.hf_project in ['afonsosamarques', 'ARDT-Project', 'ARDT-Internal', 'Experiment-1', 'Experiment-2'], "Wandb project needs to be either 'afonsosamarques' or 'ARDT-Project' or 'ARDT-Internal' or 'Experiment-1' or 'Experiment-2'."
